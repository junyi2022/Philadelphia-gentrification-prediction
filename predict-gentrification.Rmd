...
An overview of the association between gentrification and multiple independent variables. explore the positive or negative relation, and the relation statistical significanse.

```{r}
Gentrification_sum <- summary(model)

coefficients_table <- as.data.frame(Gentrification_sum$coefficients)
